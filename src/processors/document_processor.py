...
def process_documents(bl_file: BinaryIO, invoice_files: List[BinaryIO], api_key: str) -> Tuple[Dict[str, Any], List[Dict[str, Any]]]:
    ...
    # --- PROMPT DEL BL MEJORADO (Añadiendo Dirección y Teléfono explícitamente) ---
    bl_prompt = f"""
    ...
    **Formato de Salida JSON Requerido:**
    ...
    # --- PROMPT DE FACTURA MEJORADO: (Sin cambios, solo se asegura la estructura) ---
    invoice_prompt = f"""
    ...
    **Formato de Salida JSON Requerido:**
    ...
    # --- Lógica de Cálculo de CIF / Prorrateo (REGLA DE NEGOCIO: FOB + FLETE BL + 1.5% SEGURO) ---
